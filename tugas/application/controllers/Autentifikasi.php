...
class Autentifikasi extends CI_Controller
{
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success message" role="alert">Anda telah Logout</div>');
        redirect('autentifikasi');
    }
    ...
    public function registrasi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'email' => htmlspecialchars($email),'image' => 'default.jpg','password' => password_hash($this->input->post('password1'), PASSWORD_DEFAULT),
                'role_id' => 2,
                'is_active' => 0,
                'tanggal_input' => time()
            ];
